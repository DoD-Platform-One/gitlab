...
[bundled NGINX Helm chart](../nginx/_index.md) as the Ingress controller, and is documented in Kubernetes'
...
We default to [NGINX](../nginx/_index.md) mostly due to historical experience with the tool, but HAProxy is a valid alternative that may be
