...
| `config.ciphers`                                         | See description.                                        | Specify the ciphers allowed. Defaults to `[aes128-gcm@openssh.com, chacha20-poly1305@openssh.com, aes256-gcm@openssh.com, aes128-ctr, aes192-ctr, aes256-ctr]`. |
| `config.kexAlgorithms`                                   | See description.                                        | Specifies the available KEX (Key Exchange) algorithms. Defaults to `[curve25519-sha256, curve25519-sha256@libssh.org, ecdh-sha2-nistp256, ecdh-sha2-nistp384, ecdh-sha2-nistp521, diffie-hellman-group14-sha256, diffie-hellman-group14-sha1]`. |
| `config.macs`                                            | See description.                                        | Specifies the available MAC (Message Authentication Code) algorithms. Defaults to `[hmac-sha2-256-etm@openssh.com, hmac-sha2-512-etm@openssh.com, hmac-sha2-256, hmac-sha2-512, hmac-sha1]`. |
