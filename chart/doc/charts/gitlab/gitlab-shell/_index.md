...
| `config.ciphers`                                         | See description.                                        | Specify the ciphers allowed. Defaults to the [Go supported algorithms](https://pkg.go.dev/golang.org/x/crypto/ssh#SupportedAlgorithms). For FIPS builds, see the [FIPS-approved ciphers](https://gitlab.com/gitlab-org/labkit/-/blob/7bb8cb3b9f0eca4a40744520ee87a696f85c9645/fips/ssh.go#L17-20). |
| `config.kexAlgorithms`                                   | See description.                                        | Specifies the available KEX (Key Exchange) algorithms. Defaults to the [Go supported algorithms](https://pkg.go.dev/golang.org/x/crypto/ssh#SupportedAlgorithms). For FIPS builds, see the [FIPS-approved key exchange algorithms](https://gitlab.com/gitlab-org/labkit/-/blob/7bb8cb3b9f0eca4a40744520ee87a696f85c9645/fips/ssh.go#L13). |
| `config.macs`                                            | See description.                                        | Specifies the available MAC (Message Authentication Code) algorithms. Defaults to the [Go supported algorithms](https://pkg.go.dev/golang.org/x/crypto/ssh#SupportedAlgorithms). For FIPS builds, see the [FIPS-approved MACs](https://gitlab.com/gitlab-org/labkit/-/blob/7bb8cb3b9f0eca4a40744520ee87a696f85c9645/fips/ssh.go#L24-27). |
...
| `keda.minReplicaCount`                                   | `minReplicas`                                           | Minimum number of replicas KEDA will scale the resource down to. |
| `keda.maxReplicaCount`                                   | `maxReplicas`                                           | Maximum number of replicas KEDA will scale the resource up to. |
...
| `minReplicaCount`               | Integer | `minReplicas`                   | Minimum number of replicas KEDA will scale the resource down to. |
| `maxReplicaCount`               | Integer | `maxReplicas`                   | Maximum number of replicas KEDA will scale the resource up to. |
