...
| `workhorse.circuitBreaker.timeout`                            | `60`                                                            | The duration (s) to transition the circuit breaker to half-open when open |
| `workhorse.circuitBreaker.interval`                           | `180`.                                                          | The duration (s) until the circuit breaker clears consecutive failures when closed |
| `workhorse.circuitBreaker.maxRequests`                        | `1`.                                                            | The number of failed requests to open the circuit breaker when half-open |
