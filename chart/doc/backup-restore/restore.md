...
WARNING:
If you restore a GitLab installation to Azure AKS with Blob Storage, links with objects restored into blob containers will break, and your installation will be broken.
For details, including a workaround, see [issue 4682](https://gitlab.com/gitlab-org/charts/gitlab/-/issues/4682).
