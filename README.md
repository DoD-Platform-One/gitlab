...
![Version: 6.7.0-bb.3](https://img.shields.io/badge/Version-6.7.0--bb.3-informational?style=flat-square) ![AppVersion: 15.7.0](https://img.shields.io/badge/AppVersion-15.7.0-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"15.7.0"` |  |
...
| global.kubectl.image.tag | string | `"15.7.0"` |  |
...
| registry.image.tag | string | `"15.7.0"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.7.0"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.7.0"` |  |
...
| gitlab.migrations.image.tag | string | `"15.7.0"` |  |
...
| gitlab.webservice.image.tag | string | `"15.7.0"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.7.0"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.7.0"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.7.0"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.7.0"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-12-13T00-23-28Z"` |  |
