...
![Version: 8.2.7-bb.0](https://img.shields.io/badge/Version-8.2.7--bb.0-informational?style=flat-square) ![AppVersion: 17.2.7](https://img.shields.io/badge/AppVersion-17.2.7-informational?style=flat-square)
...
| global.gitlabVersion | string | `"17.2.7"` |  |
...
| global.certificates.image.tag | string | `"17.2.7"` |  |
...
| global.kubectl.image.tag | string | `"17.2.7"` |  |
...
| global.gitlabBase.image.tag | string | `"17.2.7"` |  |
...
| registry.image.tag | string | `"17.2.7"` |  |
...
| gitlab.toolbox.image.tag | string | `"17.2.7"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"17.2.7"` |  |
...
| gitlab.migrations.image.tag | string | `"17.2.7"` |  |
...
| gitlab.webservice.image.tag | string | `"17.2.7"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"17.2.7"` |  |
...
| gitlab.sidekiq.image.tag | string | `"17.2.7"` |  |
...
| gitlab.gitaly.image.tag | string | `"17.2.7"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"17.2.7"` |  |
...
| gitlab.mailroom.image.tag | string | `"17.2.7"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"17.2.7"` |  |
...
| gitlab.praefect.image.tag | string | `"17.2.7"` |  |
