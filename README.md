...
| global.certificates.image.tag | string | `"15.2.1"` |  |
...
| global.kubectl.image.tag | string | `"15.2.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.2.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.2.1"` |  |
...
| gitlab.migrations.image.tag | string | `"15.2.1"` |  |
...
| gitlab.webservice.image.tag | string | `"15.2.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.2.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.2.1"` |  |
...
| gitlab.praefect.image.tag | string | `"15.2.1"` |  |
...
| minio.imageTag | string | `"RELEASE.2022-08-13T21-54-44Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-08-11T00-30-48Z"` |  |
