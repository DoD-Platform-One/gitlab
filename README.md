...
| global.certificates.image.tag | string | `"15.6.1"` |  |
...
| global.kubectl.image.tag | string | `"15.6.1"` |  |
...
| registry.image.tag | string | `"15.6.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.6.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.6.1"` |  |
...
| gitlab.migrations.image.tag | string | `"15.6.1"` |  |
...
| gitlab.webservice.image.tag | string | `"15.6.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.6.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.6.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.6.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.6.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.6.1"` |  |
...
| gitlab.praefect.image.tag | string | `"15.6.1"` |  |
...
| minio.imageTag | string | `"RELEASE.2022-11-26T22-43-32Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-11-17T21-20-39Z"` |  |
