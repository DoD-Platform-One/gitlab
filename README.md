...
![Version: 9.5.0-bb.0](https://img.shields.io/badge/Version-9.5.0--bb.0-informational?style=flat-square) ![AppVersion: 18.5.0](https://img.shields.io/badge/AppVersion-18.5.0-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| global.certificates.image.tag | string | `"18.5.0"` |  |
...
| global.kubectl.image.tag | string | `"18.5.0"` |  |
...
| global.gitlabBase.image.tag | string | `"18.5.0"` |  |
...
| upstream.redis.metrics.image.tag | string | `"v1.79.0"` |  |
...
| upstream.registry.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.toolbox.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.gitlab-exporter.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.migrations.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.webservice.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.webservice.workhorse.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.sidekiq.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.gitaly.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.gitlab-shell.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.mailroom.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.gitlab-pages.image.tag | string | `"18.5.0"` |  |
...
| upstream.gitlab.praefect.image.tag | string | `"18.5.0"` |  |
