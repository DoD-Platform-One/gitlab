...
![Version: 6.8.1-bb.0](https://img.shields.io/badge/Version-6.8.1--bb.0-informational?style=flat-square) ![AppVersion: 15.8.1](https://img.shields.io/badge/AppVersion-15.8.1-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"15.8.1"` |  |
...
| global.kubectl.image.tag | string | `"15.8.1"` |  |
...
| redis.metrics.image.tag | string | `"v1.46.0"` |  |
...
| registry.image.tag | string | `"15.8.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.8.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.8.1"` |  |
...
| gitlab.migrations.image.tag | string | `"15.8.1"` |  |
...
| gitlab.webservice.image.tag | string | `"15.8.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.8.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.8.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.8.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.8.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.8.1"` |  |
...
| minio.imageTag | string | `"RELEASE.2023-01-31T02-24-19Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2023-01-28T20-29-38Z"` |  |
