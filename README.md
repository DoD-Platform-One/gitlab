...
![Version: 8.2.5-bb.0](https://img.shields.io/badge/Version-8.2.5--bb.0-informational?style=flat-square) ![AppVersion: 17.2.5](https://img.shields.io/badge/AppVersion-17.2.5-informational?style=flat-square)
...
| global.gitlabVersion | string | `"17.2.5"` |  |
...
| global.certificates.image.tag | string | `"17.2.5"` |  |
...
| global.kubectl.image.tag | string | `"17.2.5"` |  |
...
| global.gitlabBase.image.tag | string | `"17.2.5"` |  |
...
| registry.image.tag | string | `"17.2.5"` |  |
...
| gitlab.toolbox.image.tag | string | `"17.2.5"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"17.2.5"` |  |
...
| gitlab.migrations.image.tag | string | `"17.2.5"` |  |
...
| gitlab.webservice.image.tag | string | `"17.2.5"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"17.2.5"` |  |
...
| gitlab.sidekiq.image.tag | string | `"17.2.5"` |  |
...
| gitlab.gitaly.image.tag | string | `"17.2.5"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"17.2.5"` |  |
...
| gitlab.mailroom.image.tag | string | `"17.2.5"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"17.2.5"` |  |
...
| gitlab.praefect.image.tag | string | `"17.2.5"` |  |
