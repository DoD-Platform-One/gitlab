...
![Version: 7.0.4-bb.0](https://img.shields.io/badge/Version-7.0.4--bb.0-informational?style=flat-square) ![AppVersion: v16.0.3](https://img.shields.io/badge/AppVersion-v16.0.3-informational?style=flat-square)
...
| global.gitlabVersion | string | `"16.0.3"` |  |
...
| global.certificates.image.tag | string | `"16.0.3"` |  |
...
| global.kubectl.image.tag | string | `"16.0.3"` |  |
...
| global.busybox.image.tag | string | `"8.8"` |  |
...
| registry.image.tag | string | `"16.0.3"` |  |
...
| gitlab.toolbox.image.tag | string | `"16.0.3"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"16.0.3"` |  |
...
| gitlab.migrations.image.tag | string | `"16.0.3"` |  |
...
| gitlab.webservice.image.tag | string | `"16.0.3"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"16.0.3"` |  |
...
| gitlab.sidekiq.image.tag | string | `"16.0.3"` |  |
...
| gitlab.gitaly.image.tag | string | `"16.0.3"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"16.0.3"` |  |
...
| gitlab.mailroom.image.tag | string | `"16.0.3"` |  |
