...
![Version: 9.1.2-bb.0](https://img.shields.io/badge/Version-9.1.2--bb.0-informational?style=flat-square) ![AppVersion: 18.1.2](https://img.shields.io/badge/AppVersion-18.1.2-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| global.gitlabVersion | string | `"18.1.2"` |  |
...
| global.certificates.image.tag | string | `"18.1.2"` |  |
...
| global.kubectl.image.tag | string | `"18.1.2"` |  |
...
| global.gitlabBase.image.tag | string | `"18.1.2"` |  |
...
| registry.image.tag | string | `"18.1.2"` |  |
...
| gitlab.toolbox.image.tag | string | `"18.1.2"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"18.1.2"` |  |
...
| gitlab.migrations.image.tag | string | `"18.1.2"` |  |
...
| gitlab.webservice.image.tag | string | `"18.1.2"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"18.1.2"` |  |
...
| gitlab.sidekiq.image.tag | string | `"18.1.2"` |  |
...
| gitlab.gitaly.image.tag | string | `"18.1.2"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"18.1.2"` |  |
...
| gitlab.mailroom.image.tag | string | `"18.1.2"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"18.1.2"` |  |
...
| gitlab.praefect.image.tag | string | `"18.1.2"` |  |
