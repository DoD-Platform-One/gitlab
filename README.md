...
![Version: 6.7.5-bb.0](https://img.shields.io/badge/Version-6.7.5--bb.0-informational?style=flat-square) ![AppVersion: 15.7.5](https://img.shields.io/badge/AppVersion-15.7.5-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"15.7.5"` |  |
...
| global.kubectl.image.tag | string | `"15.7.5"` |  |
...
| registry.image.tag | string | `"15.7.5"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.7.5"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.7.5"` |  |
...
| gitlab.migrations.image.tag | string | `"15.7.5"` |  |
...
| gitlab.webservice.image.tag | string | `"15.7.5"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.7.5"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.7.5"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.7.5"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.7.5"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.7.5"` |  |
