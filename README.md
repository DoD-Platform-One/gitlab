...
| global.certificates.image.tag | string | `"18.4.1"` |  |
...
| global.kubectl.image.tag | string | `"18.4.1"` |  |
...
| global.gitlabBase.image.tag | string | `"18.4.1"` |  |
...
| upstream.redis.image.tag | string | `"8.2.1"` |  |
...
| upstream.registry.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.toolbox.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.gitlab-exporter.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.migrations.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.webservice.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.webservice.workhorse.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.sidekiq.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.gitaly.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.gitlab-shell.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.mailroom.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.gitlab-pages.image.tag | string | `"18.4.1"` |  |
...
| upstream.gitlab.praefect.image.tag | string | `"18.4.1"` |  |
