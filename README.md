...
| registry.image.tag | string | `"15.5.2"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.5.2"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.5.2"` |  |
...
| gitlab.migrations.image.tag | string | `"15.5.2"` |  |
...
| gitlab.webservice.image.tag | string | `"15.5.2"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.5.2"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.5.2"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.5.2"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.5.2"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.5.2"` |  |
...
| gitlab.praefect.image.tag | string | `"15.5.2"` |  |
