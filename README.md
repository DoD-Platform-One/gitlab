...
| global.gitlabVersion | string | `"18.4.1"` |  |
...
| global.hosts.openbao | object | `{}` |  |
| global.hosts.workspaces | object | `{}` |  |
...
| global.psql.knownDecompositions[3] | string | `"sec"` |  |
...
| global.appConfig.workspaces | object | `{}` |  |
| global.appConfig.cell.enabled | bool | `false` |  |
| global.appConfig.cell.database.skipSequenceAlteration | bool | `false` |  |
| global.appConfig.cell.topologyServiceClient.tls.enabled | bool | `false` |  |
...
| global.appConfig.oidcProvider.openidIdTokenExpireInSeconds | int | `120` |  |
...
| global.workspaces.enabled | bool | `false` |  |
...
| global.registry.database.password | object | `{}` |  |
...
| global.registry.redis.loadBalancing.password | object | `{}` |  |
...
| global.pages.customDomainMode | string | `nil` |  |
...
| global.openbao.enabled | bool | `false` |  |
| global.openbao.host | string | `nil` |  |
| global.openbao.https | string | `nil` |  |
| global.openbao.url | string | `nil` |  |
...
| upgradeCheck.image.tag | string | `"9.6"` |  |
...
| nginx-ingress.controller.podSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
| nginx-ingress-geo.<<.controller.podSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
| nginx-ingress-geo.controller.<<.podSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
| nginx-ingress.controller.image.registry | string | `"registry.gitlab.com"` |  |
| nginx-ingress-geo.<<.controller.image.registry | string | `"registry.gitlab.com"` |  |
| nginx-ingress-geo.controller.<<.image.registry | string | `"registry.gitlab.com"` |  |
| nginx-ingress.controller.image.image | string | `"gitlab-org/cloud-native/mirror/images/ingress-nginx/controller"` |  |
| nginx-ingress-geo.<<.controller.image.image | string | `"gitlab-org/cloud-native/mirror/images/ingress-nginx/controller"` |  |
| nginx-ingress-geo.controller.<<.image.image | string | `"gitlab-org/cloud-native/mirror/images/ingress-nginx/controller"` |  |
| nginx-ingress.controller.image.tag | string | `"v1.11.7"` |  |
| nginx-ingress-geo.<<.controller.image.tag | string | `"v1.11.7"` |  |
| nginx-ingress-geo.controller.<<.image.tag | string | `"v1.11.7"` |  |
| nginx-ingress.controller.image.digest | string | `"sha256:016a25cf89bf7f930869ccd7cb3dd4acbe106cd4da1419804951ef9c8636f053"` |  |
| nginx-ingress-geo.<<.controller.image.digest | string | `"sha256:016a25cf89bf7f930869ccd7cb3dd4acbe106cd4da1419804951ef9c8636f053"` |  |
| nginx-ingress-geo.controller.<<.image.digest | string | `"sha256:016a25cf89bf7f930869ccd7cb3dd4acbe106cd4da1419804951ef9c8636f053"` |  |
...
| nginx-ingress-geo.controller.<<.service.externalTrafficPolicy | string | `"Local"` |  |
| nginx-ingress-geo.<<.controller.service.ipFamilies | list | `[]` |  |
| nginx-ingress.controller.service.ipFamilies | list | `[]` |  |
| nginx-ingress-geo.controller.<<.service.ipFamilies | list | `[]` |  |
| nginx-ingress.controller.service.ipFamilyPolicy | string | `"PreferDualStack"` |  |
| nginx-ingress-geo.controller.<<.service.ipFamilyPolicy | string | `"PreferDualStack"` |  |
| nginx-ingress-geo.<<.controller.service.ipFamilyPolicy | string | `"PreferDualStack"` |  |
| nginx-ingress-geo.controller.<<.service.appProtocol | bool | `false` |  |
| nginx-ingress.controller.service.appProtocol | bool | `false` |  |
| nginx-ingress-geo.<<.controller.service.appProtocol | bool | `false` |  |
| nginx-ingress-geo.controller.<<.service.internal.appProtocol | bool | `false` |  |
| nginx-ingress-geo.<<.controller.service.internal.appProtocol | bool | `false` |  |
| nginx-ingress.controller.service.internal.appProtocol | bool | `false` |  |
...
| nginx-ingress-geo.<<.defaultBackend.podSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
| nginx-ingress.defaultBackend.podSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
...
| haproxy.controller.service.enablePorts.quic | bool | `false` |  |
...
| redis.metrics.image.tag | string | `"v1.77.0"` |  |
...
| postgresql.auth.database | string | `"gitlabhq_production"` |  |
...
| postgresql.primary.resources.limits.memory | string | `"500Mi"` |  |
| postgresql.primary.resources.requests.cpu | string | `"500m"` |  |
| postgresql.primary.resources.requests.memory | string | `"500Mi"` |  |
...
| postgresql.primary.extraVolumeMounts[1].name | string | `"custom-init-scripts"` |  |
| postgresql.primary.extraVolumeMounts[1].mountPath | string | `"/docker-entrypoint-preinitdb.d/init_revision.sh"` |  |
| postgresql.primary.extraVolumeMounts[1].subPath | string | `"init_revision.sh"` |  |
| postgresql.primary.extraVolumeMounts[2].name | string | `"registry-database-password"` |  |
| postgresql.primary.extraVolumeMounts[2].mountPath | string | `"/etc/gitlab/postgres/registry_database_password"` |  |
| postgresql.primary.extraVolumeMounts[2].subPath | string | `"database_password"` |  |
| postgresql.primary.extraVolumeMounts[2].readOnly | bool | `true` |  |
| postgresql.primary.extraVolumes[0].name | string | `"runtime"` |  |
| postgresql.primary.extraVolumes[0].emptyDir | object | `{}` |  |
| postgresql.primary.extraVolumes[1].name | string | `"registry-database-password"` |  |
| postgresql.primary.extraVolumes[1].projected.sources[0].secret.name | string | `"{{ include \"gitlab.registry.database.password.secret\" . }}"` |  |
| postgresql.primary.extraVolumes[1].projected.sources[0].secret.items[0].key | string | `"{{ include \"gitlab.registry.database.password.key\" . }}"` |  |
| postgresql.primary.extraVolumes[1].projected.sources[0].secret.items[0].path | string | `"database_password"` |  |
...
| postgresql.primary.podAnnotations."postgresql.gitlab/init-revision" | string | `"1"` |  |
...
| registry.image.tag | string | `"18.4.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"18.4.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"18.4.1"` |  |
...
| gitlab.migrations.image.tag | string | `"18.4.1"` |  |
...
| gitlab.webservice.image.tag | string | `"18.4.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"18.4.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"18.4.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"18.4.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"18.4.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"18.4.1"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"18.4.1"` |  |
...
| gitlab.praefect.image.tag | string | `"18.4.1"` |  |
