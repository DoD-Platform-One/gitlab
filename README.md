...
![Version: 6.11.3-bb.0](https://img.shields.io/badge/Version-6.11.3--bb.0-informational?style=flat-square) ![AppVersion: 15.11.3](https://img.shields.io/badge/AppVersion-15.11.3-informational?style=flat-square)
...
| global.gitlabVersion | string | `"15.11.3"` |  |
...
| global.certificates.image.tag | string | `"15.11.3"` |  |
...
| global.kubectl.image.tag | string | `"15.11.3"` |  |
...
| registry.image.tag | string | `"15.11.3"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.11.3"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.11.3"` |  |
...
| gitlab.migrations.image.tag | string | `"15.11.3"` |  |
...
| gitlab.webservice.image.tag | string | `"15.11.3"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.11.3"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.11.3"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.11.3"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.11.3"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.11.3"` |  |
