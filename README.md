...
![Version: 7.3.0-bb.0](https://img.shields.io/badge/Version-7.3.0--bb.0-informational?style=flat-square) ![AppVersion: 16.3.0](https://img.shields.io/badge/AppVersion-16.3.0-informational?style=flat-square)
...
| global.gitlabVersion | string | `"16.3.0"` |  |
...
| global.certificates.image.tag | string | `"16.3.0"` |  |
...
| global.kubectl.image.tag | string | `"16.3.0"` |  |
...
| redis.metrics.image.tag | string | `"v1.52.0"` |  |
...
| registry.image.tag | string | `"16.3.0"` |  |
...
| gitlab.toolbox.image.tag | string | `"16.3.0"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"16.3.0"` |  |
...
| gitlab.migrations.image.tag | string | `"16.3.0"` |  |
...
| gitlab.webservice.image.tag | string | `"16.3.0"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"16.3.0"` |  |
...
| gitlab.sidekiq.image.tag | string | `"16.3.0"` |  |
...
| gitlab.gitaly.image.tag | string | `"16.3.0"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"16.3.0"` |  |
...
| gitlab.mailroom.image.tag | string | `"16.3.0"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"16.3.0"` |  |
...
| gitlab.praefect.image.tag | string | `"16.3.0"` |  |
