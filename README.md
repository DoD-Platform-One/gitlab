...
![Version: 6.0.1-bb.3](https://img.shields.io/badge/Version-6.0.1--bb.3-informational?style=flat-square) ![AppVersion: 15.0.1](https://img.shields.io/badge/AppVersion-15.0.1-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"15.0.1"` |  |
...
| global.kubectl.image.tag | string | `"15.0.1"` |  |
...
| redis.metrics.image.tag | string | `"1.37.0"` |  |
...
| redis.master.podSecurityContext.runAsUser | int | `1001` |  |
...
| redis.slave.podSecurityContext.enabled | bool | `true` |  |
| redis.slave.podSecurityContext.runAsUser | int | `1001` |  |
| redis.slave.podSecurityContext.fsGroup | int | `1001` |  |
...
| registry.image.tag | string | `"15.0.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.0.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.0.1"` |  |
...
| gitlab.migrations.image.tag | string | `"15.0.1"` |  |
...
| gitlab.webservice.image.tag | string | `"15.0.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.0.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.0.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.0.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.0.1"` |  |
...
| gitlab.praefect.image.tag | string | `"15.0.1"` |  |
...
Please see the [contributing guide](./CONTRIBUTING.md) if you are interested in contributing. # gitlab
...
|  | nginx-ingress | *.*.* |
|  | registry | *.*.* |
| https://charts.gitlab.io/ | gitlab-runner | 0.41.0 |
| https://charts.jetstack.io/ | certmanager(cert-manager) | 1.5.4 |
| https://grafana.github.io/helm-charts | grafana | 6.9.1 |
| https://prometheus-community.github.io/helm-charts | prometheus | 15.0.4 |
| https://raw.githubusercontent.com/bitnami/charts/eb5f9a9513d987b519f0ecd732e7031241c50328/bitnami | postgresql | 8.9.4 |
| https://raw.githubusercontent.com/bitnami/charts/eb5f9a9513d987b519f0ecd732e7031241c50328/bitnami | redis | 11.3.4 |
| oci://registry.dso.mil/platform-one/big-bang/apps/library-charts/gluon | gluon | 0.2.9 |
...
Please see the [contributing guide](./CONTRIBUTING.md) if you are interested in contributing. # postgresql
