...
![Version: 7.11.2-bb.5](https://img.shields.io/badge/Version-7.11.2--bb.5-informational?style=flat-square) ![AppVersion: 16.11.3](https://img.shields.io/badge/AppVersion-16.11.3-informational?style=flat-square)
...
| global.gitlabVersion | string | `"16.11.3"` |  |
...
| global.certificates.image.tag | string | `"16.11.3"` |  |
...
| global.kubectl.image.tag | string | `"16.11.3"` |  |
...
| global.gitlabBase.image.tag | string | `"9.4"` |  |
...
| redis.metrics.image.tag | string | `"v1.59.0"` |  |
...
| postgresql.image.tag | string | `"14.11"` |  |
...
| registry.image.tag | string | `"16.11.3"` |  |
...
| gitlab.toolbox.image.tag | string | `"16.11.3"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"16.11.3"` |  |
...
| gitlab.migrations.image.tag | string | `"16.11.3"` |  |
...
| gitlab.webservice.image.tag | string | `"16.11.3"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"16.11.3"` |  |
...
| gitlab.sidekiq.image.tag | string | `"16.11.3"` |  |
...
| gitlab.gitaly.image.tag | string | `"16.11.3"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"16.11.3"` |  |
...
| gitlab.mailroom.image.tag | string | `"16.11.3"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"16.11.3"` |  |
...
| gitlab.praefect.image.tag | string | `"16.11.3"` |  |
