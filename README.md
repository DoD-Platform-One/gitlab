...
| global.gitlabVersion | string | `"16.9.1"` |  |
...
| global.certificates.image.tag | string | `"16.9.1"` |  |
...
| global.kubectl.image.tag | string | `"16.9.1"` |  |
...
| registry.image.tag | string | `"16.9.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"16.9.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"16.9.1"` |  |
...
| gitlab.migrations.image.tag | string | `"16.9.1"` |  |
...
| gitlab.webservice.image.tag | string | `"16.9.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"16.9.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"16.9.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"16.9.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"16.9.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"16.9.1"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"16.9.1"` |  |
...
| gitlab.praefect.image.tag | string | `"16.9.1"` |  |
