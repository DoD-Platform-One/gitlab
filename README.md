...
![Version: 8.11.1-bb.0](https://img.shields.io/badge/Version-8.11.1--bb.0-informational?style=flat-square) ![AppVersion: 17.11.1](https://img.shields.io/badge/AppVersion-17.11.1-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| global.gitlabVersion | string | `"17.11.1"` |  |
...
| global.certificates.image.tag | string | `"17.11.1"` |  |
...
| global.kubectl.image.tag | string | `"17.11.1"` |  |
...
| global.gitlabBase.image.tag | string | `"17.11.1"` |  |
...
| redis.metrics.image.tag | string | `"v1.70.0"` |  |
...
| registry.image.tag | string | `"17.11.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"17.11.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"17.11.1"` |  |
...
| gitlab.migrations.image.tag | string | `"17.11.1"` |  |
...
| gitlab.webservice.image.tag | string | `"17.11.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"17.11.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"17.11.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"17.11.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"17.11.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"17.11.1"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"17.11.1"` |  |
...
| gitlab.praefect.image.tag | string | `"17.11.1"` |  |
