...
![Version: 6.1.2-bb.2](https://img.shields.io/badge/Version-6.1.2--bb.2-informational?style=flat-square) ![AppVersion: 15.1.2](https://img.shields.io/badge/AppVersion-15.1.2-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"15.1.2"` |  |
...
| global.kubectl.image.tag | string | `"15.1.2"` |  |
...
| registry.image.tag | string | `"15.1.2"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.1.2"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.1.2"` |  |
...
| gitlab.migrations.image.tag | string | `"15.1.2"` |  |
...
| gitlab.webservice.image.tag | string | `"15.1.2"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.1.2"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.1.2"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.1.2"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.1.2"` |  |
...
| minio.imageTag | string | `"RELEASE.2022-07-08T00-05-23Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-07-06T14-54-36Z"` |  |
