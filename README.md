...
![Version: 8.7.0-bb.0](https://img.shields.io/badge/Version-8.7.0--bb.0-informational?style=flat-square) ![AppVersion: 17.7.0](https://img.shields.io/badge/AppVersion-17.7.0-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| global.gitlabVersion | string | `"17.7.0"` |  |
...
| global.certificates.image.tag | string | `"17.7.0"` |  |
...
| global.kubectl.image.tag | string | `"17.7.0"` |  |
...
| global.gitlabBase.image.tag | string | `"17.7.0"` |  |
...
| registry.image.tag | string | `"17.7.0"` |  |
...
| gitlab.toolbox.image.tag | string | `"17.7.0"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"17.7.0"` |  |
...
| gitlab.migrations.image.tag | string | `"17.7.0"` |  |
...
| gitlab.webservice.image.tag | string | `"17.7.0"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"17.7.0"` |  |
...
| gitlab.sidekiq.image.tag | string | `"17.7.0"` |  |
...
| gitlab.gitaly.image.tag | string | `"17.7.0"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"17.7.0"` |  |
...
| gitlab.mailroom.image.tag | string | `"17.7.0"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"17.7.0"` |  |
...
| gitlab.praefect.image.tag | string | `"17.7.0"` |  |
