...
| global.gitlabVersion | string | `"15.10.0"` |  |
...
| global.certificates.image.tag | string | `"15.10.0"` |  |
...
| global.kubectl.image.tag | string | `"15.10.0"` |  |
...
| registry.image.tag | string | `"15.10.0"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.10.0"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.10.0"` |  |
...
| gitlab.migrations.image.tag | string | `"15.10.0"` |  |
...
| gitlab.webservice.image.tag | string | `"15.10.0"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.10.0"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.10.0"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.10.0"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.10.0"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.10.0"` |  |
