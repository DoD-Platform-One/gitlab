...
![Version: 5.9.2-bb.0](https://img.shields.io/badge/Version-5.9.2--bb.0-informational?style=flat-square) ![AppVersion: 14.9.2](https://img.shields.io/badge/AppVersion-14.9.2-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"14.9.2"` |  |
...
| global.kubectl.image.tag | string | `"14.9.2"` |  |
...
| registry.image.tag | string | `"14.9.2"` |  |
...
| gitlab.toolbox.image.tag | string | `"14.9.2"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"14.9.2"` |  |
...
| gitlab.migrations.image.tag | string | `"14.9.2"` |  |
...
| gitlab.webservice.image.tag | string | `"14.9.2"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"14.9.2"` |  |
...
| gitlab.sidekiq.image.tag | string | `"14.9.2"` |  |
...
| gitlab.gitaly.image.tag | string | `"14.9.2"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"14.9.2"` |  |
...
| gitlab.praefect.image.tag | string | `"14.9.2"` |  |
