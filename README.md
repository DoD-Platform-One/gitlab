...
![Version: 8.2.4-bb.0](https://img.shields.io/badge/Version-8.2.4--bb.0-informational?style=flat-square) ![AppVersion: 17.2.4](https://img.shields.io/badge/AppVersion-17.2.4-informational?style=flat-square)
...
| global.gitlabVersion | string | `"17.2.4"` |  |
...
| global.certificates.image.tag | string | `"17.2.4"` |  |
...
| global.kubectl.image.tag | string | `"17.2.4"` |  |
...
| global.gitlabBase.image.tag | string | `"17.2.4"` |  |
...
| redis.metrics.image.tag | string | `"v1.62.0"` |  |
...
| postgresql.image.tag | string | `"14.13"` |  |
...
| registry.image.tag | string | `"17.2.4"` |  |
...
| gitlab.toolbox.image.tag | string | `"17.2.4"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"17.2.4"` |  |
...
| gitlab.migrations.image.tag | string | `"17.2.4"` |  |
...
| gitlab.webservice.image.tag | string | `"17.2.4"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"17.2.4"` |  |
...
| gitlab.sidekiq.image.tag | string | `"17.2.4"` |  |
...
| gitlab.gitaly.image.tag | string | `"17.2.4"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"17.2.4"` |  |
...
| gitlab.mailroom.image.tag | string | `"17.2.4"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"17.2.4"` |  |
...
| gitlab.praefect.image.tag | string | `"17.2.4"` |  |
