...
| global.certificates.image.tag | string | `"18.9.2"` |  |
...
| global.kubectl.image.tag | string | `"18.9.2"` |  |
...
| global.gitlabBase.image.tag | string | `"18.9.2"` |  |
...
| upstream.registry.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.toolbox.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.gitlab-exporter.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.migrations.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.webservice.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.webservice.workhorse.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.sidekiq.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.gitaly.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.gitlab-shell.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.mailroom.image.tag | string | `"18.9.2"` |  |
...
| upstream.gitlab.praefect.image.tag | string | `"18.9.2"` |  |
