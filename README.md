...
![Version: 6.8.2-bb.0](https://img.shields.io/badge/Version-6.8.2--bb.0-informational?style=flat-square) ![AppVersion: 15.8.2](https://img.shields.io/badge/AppVersion-15.8.2-informational?style=flat-square)
...
| global.gitlabVersion | string | `"15.8.2"` |  |
...
| global.certificates.image.tag | string | `"15.8.2"` |  |
...
| global.kubectl.image.tag | string | `"15.8.2"` |  |
...
| postgresql.image.tag | string | `"12.14"` |  |
...
| registry.image.tag | string | `"15.8.2"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.8.2"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.8.2"` |  |
...
| gitlab.migrations.image.tag | string | `"15.8.2"` |  |
...
| gitlab.webservice.image.tag | string | `"15.8.2"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.8.2"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.8.2"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.8.2"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.8.2"` |  |
