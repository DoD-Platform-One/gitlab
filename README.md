...
![Version: 8.5.1-bb.0](https://img.shields.io/badge/Version-8.5.1--bb.0-informational?style=flat-square) ![AppVersion: 17.5.1](https://img.shields.io/badge/AppVersion-17.5.1-informational?style=flat-square)
...
| global.gitlabVersion | string | `"17.5.1"` |  |
...
| global.certificates.image.tag | string | `"17.5.1"` |  |
...
| global.kubectl.image.tag | string | `"17.5.1"` |  |
...
| global.gitlabBase.image.tag | string | `"17.5.1"` |  |
...
| redis.metrics.image.tag | string | `"v1.66.0"` |  |
...
| registry.image.tag | string | `"17.5.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"17.5.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"17.5.1"` |  |
...
| gitlab.migrations.image.tag | string | `"17.5.1"` |  |
...
| gitlab.webservice.image.tag | string | `"17.5.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"17.5.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"17.5.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"17.5.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"17.5.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"17.5.1"` |  |
...
| gitlab.gitlab-pages.image.tag | string | `"17.5.1"` |  |
...
| gitlab.praefect.image.tag | string | `"17.5.1"` |  |
