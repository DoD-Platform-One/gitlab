...
![Version: 6.5.0-bb.0](https://img.shields.io/badge/Version-6.5.0--bb.0-informational?style=flat-square) ![AppVersion: 15.5.0](https://img.shields.io/badge/AppVersion-15.5.0-informational?style=flat-square)
...
| global.certificates.image.tag | string | `"15.5.0"` |  |
...
| global.kubectl.image.tag | string | `"15.5.0"` |  |
...
| registry.image.tag | string | `"15.5.0"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.5.0"` |  |
...
| gitlab.migrations.image.tag | string | `"15.5.0"` |  |
...
| gitlab.webservice.image.tag | string | `"15.5.0"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.5.0"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.5.0"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.5.0"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.5.0"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.5.0"` |  |
...
| gitlab.praefect.image.tag | string | `"15.5.0"` |  |
