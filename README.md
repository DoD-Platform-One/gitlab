...
![Version: 9.7.1-bb.0](https://img.shields.io/badge/Version-9.7.1--bb.0-informational?style=flat-square) ![AppVersion: 18.7.1](https://img.shields.io/badge/AppVersion-18.7.1-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| global.certificates.image.tag | string | `"18.7.1"` |  |
...
| global.kubectl.image.tag | string | `"18.7.1"` |  |
...
| global.gitlabBase.image.tag | string | `"18.7.0"` |  |
...
| upstream.redis.metrics.image.tag | string | `"v1.80.1"` |  |
...
| upstream.redis.image.tag | string | `"8.2.3"` |  |
...
| upstream.registry.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.toolbox.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.gitlab-exporter.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.migrations.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.webservice.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.webservice.workhorse.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.sidekiq.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.gitaly.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.gitlab-shell.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.mailroom.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.gitlab-pages.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.kas.image.tag | string | `"18.7.1"` |  |
...
| upstream.gitlab.praefect.image.tag | string | `"18.7.1"` |  |
